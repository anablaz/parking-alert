  ...
  (function (e) {
    ...
    m = function (t) {
      ...
      if (e.createStyleSheet) {
        ...
        n[
          typeof e.body.style.WebkitAppearance == "string"
            ? "innerText"
            : "innerHTML"
        ] = t;
      }
    ...
    E = o({
      ...
      init: function (t) {
        ...
        this.tooltip = r("<div/>", { id: "jqstooltip", class: n }).appendTo(
          this.container
        );
    ...
    r.fn.sparkline = function (t, i) {
      return this.each(function () {
        ...
        u = function () {
          ...
          u =
            s.get("width") === "auto"
              ? i.length * s.get("defaultPixelsPerValue")
              : s.get("width");
    ...
    r.fn.sparkline.options = o({
      init: function (e, t) {
        ...
        this.tagOptionsPrefix =
          t.enableTagOptions && (t.tagOptionsPrefix || o.tagOptionsPrefix);
    ...
    r.fn.sparkline.line = x = o(r.fn.sparkline._base, {
      ...
      drawNormalRange: function (e, r, i, s, o) {
        var u = this.options.get("normalRangeMin"),
          ...
          l = t.round((i * (a - u)) / o);
        this.target
          .drawRect(e, f, s, l, n, this.options.get("normalRangeColor"))
          .append();
      },
      render: function () {
        var e = this.options,
    ...
    r.fn.sparkline.bar = T = o(r.fn.sparkline._base, S, {
      ...
      init: function (e, i, s, o, u) {
        ...
        this.canvasHeightEf =
          A && M < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1;
        if (M < O) {
          U = H && _ >= 0 ? y : _;
      ...
      renderRegion: function (e, i) {
        ...
        if (b) {
          if (o.get("nullColor")) {
            y = i
              ? o.get("nullColor")
              : this.calcHighlightColor(o.get("nullColor"), o);
            m = v > 0 ? v - 1 : v;
    ...
    r.fn.sparkline.discrete = C = o(r.fn.sparkline._base, S, {
      ...
      renderRegion: function (e, n) {
        ...
        d = t.round(p - p * ((v - s) / u));
        m =
          i.get("thresholdColor") && v < i.get("thresholdValue")
            ? i.get("thresholdColor")
            : i.get("lineColor");
        if (n) {
    ...
    r.fn.sparkline.bullet = k = o(r.fn.sparkline._base, {
      ...
      renderTarget: function (e) {
        var n = this.values[0],
          r = t.round(
            this.canvasWidth * ((n - this.min) / this.range) -
    ...
    P = o(D, {
      ...
      _drawShape: function (e, t, r, i, s) {
        var o = this._getContext(r, i, s),
          ...
          a;
        o.beginPath();
        o.moveTo(t[0][0] + 0.5, t[0][1] + 0.5);
        for (u = 1, a = t.length; u < a; u++) {
          o.lineTo(t[u][0] + 0.5, t[u][1] + 0.5);
        }
        if (r !== n) {
          o.stroke();
        }
    ...
    H = o(D, {
      ...
      _drawShape: function (e, t, r, i, s) {
        ...
        f =
          i === n ? ' filled="false"' : ' fillColor="' + i + '" filled="true" ';
      ...
      _drawCircle: function (e, t, r, i, s, o, u) {
        ...
        a =
          s === n
            ? ' stroked="false" '
            : ' strokeWeight="' + u + 'px" strokeColor="' + s + '" ';
        f =
          o === n ? ' filled="false"' : ' fillColor="' + o + '" filled="true" ';
        l =
          "<v:oval " +
          ' id="jqsshape' +
          e +
      ...
      _drawPieSlice: function (e, r, i, s, o, u, a, f) {
        ...
        m =
          f === n ? ' filled="false"' : ' fillColor="' + f + '" filled="true" ';
        g =
          '<v:shape coordorigin="0 0" coordsize="' +
          this.pixelWidth +
          " " +
